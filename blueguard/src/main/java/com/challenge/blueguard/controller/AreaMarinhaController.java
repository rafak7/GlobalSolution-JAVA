...
public class AreaMarinhaController {
    ...
    public ResponseEntity<List<EntityModel<AreaMarinhaDTO>>> listar() {
        List<EntityModel<AreaMarinhaDTO>> area = areaMarinhaService.listarAreaMarinha().stream()
    ...
    public ResponseEntity<EntityModel<AreaMarinhaDTO>> criarArea(@RequestBody AreaMarinhaDTO areaMarinhaDTO) {
        AreaMarinhaDTO novaArea = areaMarinhaService.salvarAreaMarinha(areaMarinhaDTO);
        EntityModel<AreaMarinhaDTO> resource = EntityModel.of(novaArea,
    ...
    public ResponseEntity<EntityModel<AreaMarinhaDTO>> atualizarArea(@PathVariable Long id, @RequestBody AreaMarinhaDTO areaMarinhaDTO){
        AreaMarinhaDTO areaAtualizada = areaMarinhaService.atualizarAreaMarinha(areaMarinhaDTO, id);
        EntityModel<AreaMarinhaDTO> resource = EntityModel.of(areaAtualizada,
                createLinkWithMethod("PUT", WebMvcLinkBuilder.methodOn(AreaMarinhaController.class).atualizarArea(id, areaMarinhaDTO), "self"),
    ...
    public ResponseEntity<EntityModel<AreaMarinhaDTO>> consultarId(@PathVariable Long id) {
        AreaMarinhaDTO areaMarinha = areaMarinhaService.buscarAreaMarinhaPorId(id)
                .orElseThrow(() -> new IllegalArgumentException("Área Não Encontrada"));
        EntityModel<AreaMarinhaDTO> resource = EntityModel.of(areaMarinha,
                createLinkWithMethod("GET", WebMvcLinkBuilder.methodOn(AreaMarinhaController.class).consultarId(areaMarinha.getIdAreaMarinha()), "self"),
                createLinkWithMethod("GET", WebMvcLinkBuilder.methodOn(AreaMarinhaController.class).listar(), "area"));
        return ResponseEntity.ok(resource);
    }
    ...
    public ResponseEntity<EntityModel<AreaMarinhaDTO>> atualizarParcialmente(@PathVariable Long id, @RequestBody Map<String, Object> updates) {
        AreaMarinhaDTO areaAtualizada = areaMarinhaService.atualizarParcialmente(id, updates);
    ...
    public ResponseEntity<?> consultarHead(@PathVariable Long id) {
        Optional<AreaMarinhaDTO> areaMarinha = areaMarinhaService.buscarAreaMarinhaPorId(id);
